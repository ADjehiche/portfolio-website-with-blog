...
<head>
    ...
    <meta name="author" content="Acil Djehiche">
    <title>Acil Djehiche</title>
...
<div class= "container">
    <div class="welcome">
        <h1>!مرحباً Welcome! Bienvenue!</h1>
        <br>
        <h2>About Me</h2>
        <article class="about-me">
            <p id="About">My name is Acil Djehiche, and I am passionate about designing and developing innovative solutions for 
                the web. My programming journey began with Python, swiftly expanded to Java, and further evolved into 
                comprehensive web development. Currently, I am pursuing a Bsc degree in Computer Science at 
                Queen Mary University of London. As a dedicated first-year student, I am committed to excelling in 
                my studies and aiming to graduate with first-class honors.</p>
        </article>
    </div>
    <figure>
        <img src="images/adjehiche.png" alt="Acil Djehiche" id="myPic">
        <figcaption>Acil</figcaption>
    </figure>
</body>
</div>
    <footer>
