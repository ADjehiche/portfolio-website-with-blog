...
<body>
    ...
    <div id="experience-and-education">
    <section class="education">
        <h2>Education</h2>
        <article class="block">
            <a href="https://www.qmul.ac.uk/" target="_blank" id="QMUL">Queen Mary University of London</a>
            <p>Computer Science - BSc</p>
            <p>First Year Class of 2026</p>
        </article>
        <article class="block">
            <a href="https://lammas-gst.org/" target="_blank" id="Lammas">Lammas Sixthform</a>
            <p>Computer Science, Maths, Physics</p>
            <p>September 2021 - August 2023</p>
        </article>
    </section>
    <section class="experience">
        <h2>Experience</h2>
        <article class="block">
            <h3>Assistant IT Technician</h3>
            <p>Chace School</p>
            <p>Assisted in daily school maintenance, including fixing computers and addressing server problems.</p>
            <p>11 - 15 July 2022</p>
        </article>
        <article class="block">
            <h3>Tutor</h3>
            <p>HM Tutors</p>
            <p>Tutoring GCSE Maths, Physics, and Computer Science.</p>
        </article>
    </section>
</div>
<div class="skills">
    <div class="topSkills">
        ...
        <figure class="top3">
            <img src="images/first.png" alt="Python">
            <h2>Python</h2>
            <p>I have 3 years experience in python having created a Hotel MIS</p>
            <img src="images/second.png" alt="Web Development">
            <h2>Web Development</h2>
            <p>HTML, CSS, JavaScript, PHP, SQL</p>
            <img src="images/third.png" alt="Java" class="third">
            <h2 class="third">Java</h2>
            <p class="third">Experience in Java, procedural programming and OOP.</p>
        </figure>
    </div>
</div>
<footer>
