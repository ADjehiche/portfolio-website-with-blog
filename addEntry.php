...
<body>
    ...
    <div id="addBlog">
        <form id ="form" action="preview.php" method="post">
            <fieldset> Add Blog</fieldset>
            <p>The title field is empty</p>
            <textarea name="blogTitle" placeholder="Title" class="text" cols="50" id="title"></textarea>
            <p>The content field is empty</p>
            <textarea class="text" name="blogContent" cols= "50" rows ="15" placeholder="Enter your text here" id="content"></textarea>
            <div class="buttonsContainer">
                <input name = "action" type="submit" value="Post" id="post">
                <input name="action" type="submit" id="preview" value="Preview">
